...
rem Malfunctioning in C# so resorting to just copying, for now...
...
rem jcr6 add -doj -jif debug.jif ../MKL_Update/bin/Debug/MKL_Update.jcr
type ..\MKL_Update\bin\Release\MKL_Update.jcr > ..\MKL_Update\bin\Debug\MKL_Update.jcr 
echo All done
